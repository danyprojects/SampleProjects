...
namespace Bacterio.Common
{
	public class MTRandom
	{
		...
		/// Returns a new seed
		/// </summary>
		public static int RandomSeed { get { return UnityEngine.Random.Range(int.MinValue, int.MaxValue); } }

		public int Seed { get { return _rand.Seed; } }
		...
		public MTRandom()
		{
			_rand = new MersenneTwister(RandomSeed);
		}
		...
		public Vector2 PointInUnitCircle()
		{

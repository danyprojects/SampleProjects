...
namespace Tucano.Random
{
    public static class RandomCube
	{
		...
		public static Vector3 Surface(ref NPack.MersenneTwister _rand, MTRandom.Normalization n, float t)
		{
		...
		public static Vector3 Volume(ref NPack.MersenneTwister _rand, MTRandom.Normalization n, float t)
		{
			float x, y, z;
			x = y = z = 0;
			switch (n) {

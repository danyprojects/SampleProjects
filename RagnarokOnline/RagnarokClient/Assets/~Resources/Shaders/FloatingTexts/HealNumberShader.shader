Shader "Custom/Floating Text/Heal Number Shader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
				...
				const float SCALE_DURATION = 0.400;
				...
				float scaleFactor = clamp(-(((MAX_SIZE - MIN_SIZE) / SCALE_DURATION) * elapsedTime) + MAX_SIZE, MIN_SIZE, MAX_SIZE);
				...
				o.uv = v.uv;
				o.color = v.color * float4(0, 1, 0, 1); //green

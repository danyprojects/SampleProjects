...
Shader "UI/BattleModeSlotTransparent"
{
	Properties
	{
		...
		SubShader
		{
			...
			CGPROGRAM
				...
				{
					//shift 1 pixel up
					IN.texcoord.y = IN.texcoord.y - 1 / 24.0;
					...
					float flag = ceil(color.a);
					color = (1 - flag) * IN.color + color * flag; //tint tranparent pixels with vertex color

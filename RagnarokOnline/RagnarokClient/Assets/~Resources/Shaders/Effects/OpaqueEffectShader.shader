Shader "Custom/Effect Shader Opaque"
{
    Properties
    {
		...
		[Toggle(BILLBOARD)] _Billboard("Billboard", Float) = 0 //2 materials with this property being different will generate 2 shader code in compile time
    }
    SubShader
    {
        Tags 
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
				...
				col.a *= 1.3; //Default alpha is too dark
				col *= col.a;
